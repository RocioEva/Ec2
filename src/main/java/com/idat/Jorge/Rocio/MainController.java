...
@RequestMapping(path="/idat/curso") // This means URL's start with /demo (after Application path)
public class MainController {
    ...
    public @ResponseBody String editUser (@RequestParam Integer id, @RequestParam String curso
            , @RequestParam String credito) {
        User n = new User();
        n.setId(id);
        n.setCurso(curso);
